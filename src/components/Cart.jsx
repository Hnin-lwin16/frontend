    ...
    <div className="container">
      <div className="row">
        <div className="col-md-12">
          <BreadCrumb currentPageTitle="Cart" />
        </div>
        <div className="col-md-12">
          ...
          <table className="table">
            {
              cartData.length == 0 &&
              <tr>
                <td align="center" valign="middle" style={{height: 200}} colSpan={4}>Your Cart is empty</td>
              </tr>
            }
            <tbody>
              {cartData &&
                    ...
                    <tr key={`cart-${item.id}`}>
                      ...
                      <td valign="middle">
                        <input
                          ...
                          onChange={(e) => handledQty(e,item.id)}
